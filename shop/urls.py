...
urlpatterns = [
    ...
    path('products/<int:product_id>/update', Product_Update.as_view(), name = 'update_product_url'),
    path('products/add', Product_Create.as_view(), name = 'add_product_url'),
    path('products/<int:product_id>/delete', Product_Delete.as_view(), name = 'delete_product_url'),
    path('comment/<int:product_id>', add_comment, name='add_comment_url'),
    path('order/<int:product_id>/order', order_product, name='add_order_url'),
